"""
RAG Upload Script for Chapter 5: Computer Vision for Robotics
...
COLLECTION_NAME = "textbook_chapter_5"
...
def main():
    ...
    print("Starting RAG upload for Chapter 5: Computer Vision for Robotics")
