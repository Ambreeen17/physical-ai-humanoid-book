...
class lab161Node(Node):
    def __init__(self):
        super().__init__('lab_16_1_node')
        
        # Publisher for lab results
        self.publisher = self.create_publisher(String, 'lab_16_1/result', 10)
        ...
        self.get_logger().info('Introduction to Capstone Project - Basic Concepts node initialized')
