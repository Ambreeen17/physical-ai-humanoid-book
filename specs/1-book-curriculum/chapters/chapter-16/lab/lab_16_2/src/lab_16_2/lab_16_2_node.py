...
class lab162Node(Node):
    def __init__(self):
        super().__init__('lab_16_2_node')
        
        # Publisher for lab results
        self.publisher = self.create_publisher(String, 'lab_16_2/result', 10)
        ...
        self.get_logger().info('Intermediate Capstone Project - Implementation node initialized')
