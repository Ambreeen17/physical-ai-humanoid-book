"""
RAG Upload Script for Chapter 6: Control Theory Fundamentals
...
COLLECTION_NAME = "textbook_chapter_6"
    ...
    for i, (chunk, embedding) in enumerate(zip(chunks, embeddings)):
        point = models.PointStruct(
            ...
            payload={
                ...
                "type": chunk["type"],
                "chapter": 6,
                "topic": "Control Theory Fundamentals",
...
def main():
    ...
    print("Starting RAG upload for Chapter 6: Control Theory Fundamentals")
