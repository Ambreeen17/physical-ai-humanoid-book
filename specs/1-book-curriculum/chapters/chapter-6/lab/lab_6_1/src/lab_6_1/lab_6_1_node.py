...
class lab61Node(Node):
    def __init__(self):
        super().__init__('lab_6_1_node')
        
        # Publisher for lab results
        self.publisher = self.create_publisher(String, 'lab_6_1/result', 10)
        ...
        self.get_logger().info('Introduction to Control Theory Fundamentals - Basic Concepts node initialized')
