...
class lab62Node(Node):
    def __init__(self):
        super().__init__('lab_6_2_node')
        
        # Publisher for lab results
        self.publisher = self.create_publisher(String, 'lab_6_2/result', 10)
        ...
        self.get_logger().info('Intermediate Control Theory Fundamentals - Implementation node initialized')
