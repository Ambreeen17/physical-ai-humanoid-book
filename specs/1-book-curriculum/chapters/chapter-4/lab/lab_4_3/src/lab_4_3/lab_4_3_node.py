...
class lab43Node(Node):
    def __init__(self):
        super().__init__('lab_4_3_node')
        
        # Publisher for lab results
        self.publisher = self.create_publisher(String, 'lab_4_3/result', 10)
        ...
        self.get_logger().info('Advanced State Estimation - Integration and Optimization node initialized')
