...
class lab81Node(Node):
    def __init__(self):
        super().__init__('lab_8_1_node')
        
        # Publisher for lab results
        self.publisher = self.create_publisher(String, 'lab_8_1/result', 10)
        ...
        self.get_logger().info('Introduction to Manipulation & Grasping - Basic Concepts node initialized')
