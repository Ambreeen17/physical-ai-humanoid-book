...
class lab142Node(Node):
    def __init__(self):
        super().__init__('lab_14_2_node')
        
        # Publisher for lab results
        self.publisher = self.create_publisher(String, 'lab_14_2/result', 10)
        ...
        self.get_logger().info('Intermediate Safety & Robustness - Implementation node initialized')
