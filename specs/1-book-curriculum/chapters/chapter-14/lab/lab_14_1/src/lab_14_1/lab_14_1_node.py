...
class lab141Node(Node):
    def __init__(self):
        super().__init__('lab_14_1_node')
        
        # Publisher for lab results
        self.publisher = self.create_publisher(String, 'lab_14_1/result', 10)
        ...
        self.get_logger().info('Introduction to Safety & Robustness - Basic Concepts node initialized')
