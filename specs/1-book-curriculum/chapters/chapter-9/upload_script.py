"""
RAG Upload Script for Chapter 9: Task & Motion Planning
...
COLLECTION_NAME = "textbook_chapter_9"
...
def main():
    ...
    print("Starting RAG upload for Chapter 9: Task & Motion Planning")
