...
class lab92Node(Node):
    def __init__(self):
        super().__init__('lab_9_2_node')
        
        # Publisher for lab results
        self.publisher = self.create_publisher(String, 'lab_9_2/result', 10)
        ...
        self.get_logger().info('Intermediate Task & Motion Planning - Implementation node initialized')
