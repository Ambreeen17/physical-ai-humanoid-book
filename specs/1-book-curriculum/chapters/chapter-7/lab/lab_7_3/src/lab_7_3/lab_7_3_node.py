...
class lab73Node(Node):
    def __init__(self):
        super().__init__('lab_7_3_node')
        
        # Publisher for lab results
        self.publisher = self.create_publisher(String, 'lab_7_3/result', 10)
        ...
        self.get_logger().info('Advanced Motion Planning - Integration and Optimization node initialized')
