...
class lab72Node(Node):
    def __init__(self):
        super().__init__('lab_7_2_node')
        
        # Publisher for lab results
        self.publisher = self.create_publisher(String, 'lab_7_2/result', 10)
        ...
        self.get_logger().info('Intermediate Motion Planning - Implementation node initialized')
