# Chapter 7 Assessments: Motion Planning

## Assessment Overview

This document contains assessments for Chapter 7: Motion Planning. The assessments are designed to test understanding of the learning objectives and practical application of concepts.
...
- LO1: Implement sampling-based motion planning algorithms (PRM, RRT, RRT*)
- LO2: Apply optimization-based planning methods (CHOMP, STOMP, TrajOpt)
- LO3: Design real-time replanning systems for dynamic environments
- LO4: Integrate perception and planning for obstacle avoidance
- LO5: Evaluate planning performance in terms of completeness, optimality, and efficiency


## Multiple Choice Questions

### Question 1 (1 point)
Which of the following best describes the primary purpose of Motion Planning in robotics?
...
**Difficulty**: Beginner
**Explanation**: Motion Planning enables robots to perceive and interact with their environment, which is fundamental to robotic functionality.

### Question 2 (1 point)
In the context of Motion Planning, what does the term "real-time constraint" refer to?
...
### Question 3 (1 point)
Which of the following is a key consideration when implementing Motion Planning on the Unitree G1 robot?
...
**Difficulty**: Advanced
**Explanation**: Computational resources and sensor integration are critical for effective Motion Planning implementation on the Unitree G1.

## Short Answer Questions

### Question 4 (5 points)
Explain the key differences between traditional approaches to Motion Planning and modern implementations. Include at least three specific differences in your response.
...
**Difficulty**: Advanced
**Expected Files**: motion_planning_node.py
**Scoring Rubric**:
...
class MotionPlanningNode(Node):
    ...
    def sensor_callback(self, msg):
        # Process sensor data according to Motion Planning principles
        pass
...
### Question 6 (5 points)
Design an optimization strategy for Motion Planning implementation that balances computational efficiency with accuracy. Consider the constraints of the Unitree G1 robot and provide specific recommendations for:
...
- Implementation of Motion Planning logic (2 points)
...
**Assessments generated**: 2026-01-05T23:06:03.805055
