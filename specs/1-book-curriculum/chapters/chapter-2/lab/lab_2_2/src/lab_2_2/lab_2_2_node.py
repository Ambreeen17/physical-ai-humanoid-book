...
class lab22Node(Node):
    def __init__(self):
        super().__init__('lab_2_2_node')
        
        # Publisher for lab results
        self.publisher = self.create_publisher(String, 'lab_2_2/result', 10)
        ...
        self.get_logger().info('Intermediate Kinematics & Dynamics - Implementation node initialized')
