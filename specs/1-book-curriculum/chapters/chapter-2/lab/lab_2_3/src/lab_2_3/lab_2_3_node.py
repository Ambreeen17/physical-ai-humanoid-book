...
class lab23Node(Node):
    def __init__(self):
        super().__init__('lab_2_3_node')
        
        # Publisher for lab results
        self.publisher = self.create_publisher(String, 'lab_2_3/result', 10)
        ...
        self.get_logger().info('Advanced Kinematics & Dynamics - Integration and Optimization node initialized')
