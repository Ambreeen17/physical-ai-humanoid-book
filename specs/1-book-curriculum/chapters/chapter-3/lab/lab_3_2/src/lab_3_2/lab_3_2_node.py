...
class lab32Node(Node):
    def __init__(self):
        super().__init__('lab_3_2_node')
        
        # Publisher for lab results
        self.publisher = self.create_publisher(String, 'lab_3_2/result', 10)
        ...
        self.get_logger().info('Intermediate Sensors & Actuators - Implementation node initialized')
