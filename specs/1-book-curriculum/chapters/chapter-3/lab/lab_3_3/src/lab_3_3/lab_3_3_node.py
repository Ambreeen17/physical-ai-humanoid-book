...
class lab33Node(Node):
    def __init__(self):
        super().__init__('lab_3_3_node')
        
        # Publisher for lab results
        self.publisher = self.create_publisher(String, 'lab_3_3/result', 10)
        ...
        self.get_logger().info('Advanced Sensors & Actuators - Integration and Optimization node initialized')
