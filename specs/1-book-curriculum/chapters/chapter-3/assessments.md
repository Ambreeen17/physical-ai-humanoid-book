# Chapter 3 Assessments: Sensors & Actuators

## Assessment Overview

This document contains assessments for Chapter 3: Sensors & Actuators. The assessments are designed to test understanding of the learning objectives and practical application of concepts.
...
- LO1: Characterize sensor performance (resolution, noise, latency)
- LO2: Process LiDAR point clouds for obstacle detection
- LO3: Calibrate RGB-D cameras for depth estimation
- LO4: Select actuators based on torque, speed, and precision requirements
- LO5: Implement sensor fusion using Kalman filters


## Multiple Choice Questions

### Question 1 (1 point)
Which of the following best describes the primary purpose of Sensors & Actuators in robotics?
...
**Difficulty**: Beginner
**Explanation**: Sensors & Actuators enables robots to perceive and interact with their environment, which is fundamental to robotic functionality.

### Question 2 (1 point)
In the context of Sensors & Actuators, what does the term "real-time constraint" refer to?
...
### Question 3 (1 point)
Which of the following is a key consideration when implementing Sensors & Actuators on the Unitree G1 robot?
...
**Difficulty**: Advanced
**Explanation**: Computational resources and sensor integration are critical for effective Sensors & Actuators implementation on the Unitree G1.

## Short Answer Questions

### Question 4 (5 points)
Explain the key differences between traditional approaches to Sensors & Actuators and modern implementations. Include at least three specific differences in your response.
...
**Difficulty**: Advanced
**Expected Files**: sensors_&_actuators_node.py
**Scoring Rubric**:
...
class Sensors&ActuatorsNode(Node):
    ...
    def sensor_callback(self, msg):
        # Process sensor data according to Sensors & Actuators principles
        pass
...
### Question 6 (5 points)
Design an optimization strategy for Sensors & Actuators implementation that balances computational efficiency with accuracy. Consider the constraints of the Unitree G1 robot and provide specific recommendations for:
...
- Implementation of Sensors & Actuators logic (2 points)
...
**Assessments generated**: 2026-01-05T21:42:50.815740
