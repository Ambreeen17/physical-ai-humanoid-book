"""
RAG Upload Script for Chapter 10: Reinforcement Learning for Robotics
...
COLLECTION_NAME = "textbook_chapter_10"
...
def main():
    ...
    print("Starting RAG upload for Chapter 10: Reinforcement Learning for Robotics")
