...
class lab103Node(Node):
    def __init__(self):
        super().__init__('lab_10_3_node')
        
        # Publisher for lab results
        self.publisher = self.create_publisher(String, 'lab_10_3/result', 10)
        ...
        self.get_logger().info('Advanced Reinforcement Learning for Robotics - Integration and Optimization node initialized')
