...
class lab101Node(Node):
    def __init__(self):
        super().__init__('lab_10_1_node')
        
        # Publisher for lab results
        self.publisher = self.create_publisher(String, 'lab_10_1/result', 10)
        ...
        self.get_logger().info('Introduction to Reinforcement Learning for Robotics - Basic Concepts node initialized')
